...
Por este motivo, cada vez que el implementador vaya a instalar un nuevo cliente se deberá de cambiar el filtro list_db = True, y una vez que haya finalizado la instalación del Odoo del nuevo cliente se retornará a list_db = False.
